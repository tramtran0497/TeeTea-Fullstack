...
const listDeliveryServices = [
  {
    ...
    title: 'Delivery F&B',
    subtitle:
      'There are two options delivery services: TeaTee and others(Foodora & Woff). With others, create your account and you receive codeFREE for first delivery! (asking details in cashier or customer services)',
    content: [
  ...
  },
  {
    ...
    subtitle:
      "The specialist service at TeeTea Restaurant! Let' us help you to bring all the best to your friends and your family!",
    content: [
  ...
  },
  {
    ...
    subtitle:
      'Who needs this services? And you are busy, you can not handle cooking and preparing your meal!',
    content: [
  ...
  },
  {
    ...
    subtitle:
      'How about Delivery Monthly? If Delivery Times is not enough! why do not you choose this service? Saving more money with delivery monthly, weekly, daily.',
    content: [
    ...
    <div className={styles.container}>
      ...
      <div className={styles.wrapper}>
        ...
        <div className={styles.content}>
          <ul>
            {listDeliveryServices.map((service) => (
              <DeliveryCard delivery={service} key={service.id} />
            ))}
          </ul>
        </div>
      </div>
