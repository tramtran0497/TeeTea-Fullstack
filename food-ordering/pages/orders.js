  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.currentOrders}>
        ...
        {isOrdering ? (
          ...
          <p className={styles.command}>
            Sorry, you do not have any orders right now, let&apos;s order your meal!
          </p>
        )}
      </div>
      <div className={styles.historyList}>
        ...
        <ul>
          <li>
            Receipt - <span>date 20-11-2021</span>
          </li>
          <li>
            Receipt - <span>date 23-12-2021</span>
          </li>
          <li>
            Receipt - <span>date 31-12-2021</span>
          </li>
        </ul>
      </div>
    </div>
