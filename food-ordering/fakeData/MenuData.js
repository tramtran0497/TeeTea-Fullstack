...
export const listProducts = [
  ...
  },
  {
    ...
    type: 'Best Food Item',
    listAddIngredient: [
      'Salad Cucumber with Sessame Oil',
      'Kim chi',
      'Sausages',
      'Ramen',
      'Cheese',
...
export const eventList = [
  ...
  },
  {
    ...
    img: event3,
    firstWord:
      'Taking delicious foods and drinks photos and posting on your social media, sharing the best to your family and friends!',
  ...
  },
  {
    ...
    img: event4,
    firstWord:
      "It is time for you to become our friendly customer, let's join with us! Creating a new member card in a second!",
