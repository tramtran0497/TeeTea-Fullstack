...
test("should return 401 when delete a specific event without permission", async () => {
  await supertest.delete(`/job/${jobId}`).send().expect(401);
});
