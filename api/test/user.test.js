...
test(`should return status code 401 when logout without authorization`, async () => {
  await supertest.post("/logout").send().expect(401);
});
...
test(`should return status code 401 without authorization`, async () => {
  await supertest.get("/user/username").send().expect(401);
});
...
test(`should return status code 401 without authorization`, async () => {
  await supertest.delete("/user/username").send().expect(401);
});
...
test(`should return status code 401 without authorization`, async () => {
  await supertest.delete("/user/username/avatar").send().expect(401);
});
...
test(`should return status code 401 without authorization`, async () => {
  await supertest.get("/users").send().expect(401);
});
